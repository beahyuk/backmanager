     ...
     :rules="LoginRules"
      ...
      style="margin-top:40px">
        <el-row>
          ...
          <el-col :span="22">
            <el-input class="inps" placeholder="用户名" v-model="formdata.useraccount"></el-input>
          </el-col>
        </el-row>
      </el-form-item>
      ...
      <el-form-item label="" prop="passWord">
        <el-row>
          ...
          <el-col :span="22">
            <el-input class="inps" placeholder="密码" v-model="formdata.password" show-password @keyup.enter.native="clickbtn"></el-input>
          </el-col>
        </el-row>
      </el-form-item>
      ...
      <el-form-item  style="margin-top:55px">
        <el-row type="flex" justify="center">
          <el-col :span="10">
            <el-button type="primary" round @click="clickbtn">登录</el-button>
          </el-col>
          <el-col :span="10">
            <el-button round @click="regClick">注册</el-button>
          </el-col>
        </el-row>
      </el-form-item>
    </el-form>
