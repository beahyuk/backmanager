...
<el-container direction="vertical">
  ...
  <el-main style="height: 585px; width:100%;background-color: rgb(255, 255, 255);">
    <Table :SearchMonitor="searchMonitor" :ProjectData="projectData"></Table>
  </el-main>
</el-container>
</template>

<script>
import Table from "views/category1/pages/projectmanage/Table.vue"
import Search from "views/category1/pages/projectmanage/Search.vue"
export default {
  name: "ProjectManage",
  data() {
    return {
